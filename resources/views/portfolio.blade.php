...
<head>
    ...
    <title>VERLY_RAHMA_AULIA // BLACKPINK_CYBER</title>
                ...
                <div class="pixel-border p-4">
                    ...
                    <div class="flex overflow-x-auto gap-4 pb-4 scroll-custom snap-x snap-mandatory">
                        ...
                        <div class="min-w-[160px] md:min-w-[180px] snap-center">
                            <div class="border-2 border-pink-900 p-1 bg-black group">
                                <div class="relative overflow-hidden aspect-[3/4] bg-pink-950">
                                    ...
                                    <img src="{{ asset('images/Integritas Harga Mati.png')}}" 
                                        alt="Commission 01" 
                                        class="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity">
                                </div>
                        ...
                        <div class="min-w-[160px] md:min-w-[180px] snap-center">
                            <div class="border-2 border-pink-900 p-1 bg-black group">
                                <div class="relative overflow-hidden aspect-[3/4] bg-pink-950">
                                    <img src="{{ asset('images/Delphina Carissa Mumtaz_K1401231145.jpg')}}" 
                                        alt="Commission 02" 
                                        class="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity">
                                </div>
                        ...
                        <div class="min-w-[160px] md:min-w-[180px] snap-center">
                            <div class="border-2 border-pink-900 p-1 bg-black group">
                                <div class="relative overflow-hidden aspect-[3/4] bg-pink-950">
                                    <img src="{{ asset('images/Kemitraan Multipihak Berbasis ICT.png')}}" 
                                        alt="Commission 03" 
                                        class="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity">
                                </div>
